...
>(
  (
    ...
    }, [label, labelFormatter, payload, hideLabel, config, labelClassName, labelKey]);
                    ...
                    {!hideIndicator && (
                      <div
                        className={cn(
                          ...
                          {
                            "my-0.5 h-2 w-2": indicator === "dot",
                            "h-2 w-2": indicator === "dashed",
                            "my-0.5 h-px w-3": indicator === "line",
                          }
                        )}
                        style={
                          {
